...
const PM = () => {
    ...
    useEffect(()=>{
        ...
        const getAvgFakultas = async () =>{
            try {
                const dataFakultas = await axios.get(`https://pasta-finder-back.vercel.app/scores/${id}/fakultas`);
                setAvgFakultas({
                    ...avgFakultas,
        ...
        const getAvgUniv = async () =>{
            try {
                const dataUniv= await axios.get(`https://pasta-finder-back.vercel.app/scores/${id}/univ`);
                setAvgUniv({
                    ...avgUniv,
